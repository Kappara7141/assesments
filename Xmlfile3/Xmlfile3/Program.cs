...
namespace Xmlfile3
{
    class Program
    {
        private static void Xmldemo()
        {
            ...
            xmld.Load(@"D:\vs2017\c# programs\Xmlfile3\Xmlfile3\book.xml");
        ...
        static void Main(string[] args)
        {
            ...
            int i = 0;
            string str = null;
            FileStream fs = new FileStream(@"D:\vs2017\c# programs\Xmlfile3\Xmlfile3\book.xml", FileMode.Open, FileAccess.Read);
            xmldoc.Load(fs);
