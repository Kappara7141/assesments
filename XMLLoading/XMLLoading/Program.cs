...
namespace XMLLoading
{
    class Program
    {
        ...
        private static void Xmldemo()
        {
            ...
            xmld.Load(@"D:\vs2017\c# programs\XMLLoading\XMLLoading\XML1.xml");
        ...
        static void Main(string[]args)
        {
            ...
            int i = 0;
            string str = null;
            FileStream fs = new FileStream(@"D:\vs2017\c# programs\XMLLoading\XMLLoading\XML1.xml", FileMode.Open,FileAccess.Read);
